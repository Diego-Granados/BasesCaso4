...
select *
	...
	INNER JOIN (SELECT localId, COUNT(localId) localesCount FROM viajesRecoleccion GROUP BY localId) vc ON viajesRecoleccion.localId = vc.localId
...
update desechosplantaslogs
set viajeid = 4
where desplantlogid = 7 or desPlantLogId = 8
*/