...
CREATE PROCEDURE [dbo].[SP_registrarFacturaRecoleccionDR2Fix]
...
BEGIN
	...
	BEGIN TRY
		...
		/*
		T2 necesita leer saldosDistribución, pero T1 tiene un write lock sobre 
		esta tabla ya que la modificó y no ha llegado al commit. Por lo tanto, 
		T2 debe esperar a que T1 haga rollback o llegue al punto de commit para
		continuar.
		Después de que T1 haga rollback, T2 lee el valor correcto de 600.
		Puede seguir su ejecución normalmente.
		*/
