...
DROP PROCEDURE IF EXISTS  [dbo].[SP_registrarFacturaRecoleccionDR1Fix];
GO
/*
...
CREATE PROCEDURE [dbo].[SP_registrarFacturaRecoleccionDR1Fix]
...
BEGIN
	...
	/*
	Para solucionar el problema del dirty read, hay que cambiar el nivel de
	isolación a Read Committed. De esta manera, las transacciones no pueden leer
	datos que han sido modificados pero no commiteados todavía.
	*/
	...
	BEGIN TRY
		...
		*/
		...
		es Read Commited, tampoco puede leer. Debe esperar a que T1 libere el
		write lock para poder leer.
		*/
